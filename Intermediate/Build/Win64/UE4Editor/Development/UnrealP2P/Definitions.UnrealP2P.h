...
#define UE_PROJECT_NAME AdvancedUnrealP2P
#define UE_TARGET_NAME AdvancedUnrealP2PEditor
#define UE_MODULE_NAME "UnrealP2P"
#define UE_PLUGIN_NAME "UnrealP2P"
...
#define UNREALP2P_API DLLEXPORT
